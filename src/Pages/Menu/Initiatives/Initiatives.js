      ...
      <MDBContainer maxWidth="lg">
        ...
        <Card sx={{ maxWidth: 345, mr: 4 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              The Approvals Bureau processes proposals for grant of approval for
              establishing a new technical institution or an integrated campus.
            </Typography>
          </CardContent>
          <CardActions>
            ...
            <div>
              <div className="item">
                <img
                  alt="article"
                  className="item-image"
                  src="/images/onestudentonetree.JPG"
                  style={{ width: 200 }}
                />
                <h3 className="item-head">One Student One Tree</h3>
                <p className="item-desc">
                  Hon’ble HRD Minister Dr. Ramesh Pokhriyal “Nishank” launched a
                  campaign “One Student One Tree” on 20th July. This initiative
                  is in line with the Hon’ble Prime Minister’s idea of a green
            ...
            <div>
              <div className="item">
                <img
                  alt="article"
                  className="item-image"
                  src="/images/ukieri.JPG"
                  style={{ width: 200 }}
                />
                <h3 className="item-head">AICTE-UKEIRI 2020-21</h3>
                <p className="item-desc">
                  UK India Education Research Initiative (UKIERI) was started in
                  April 2006 with the aim of enhancing educational links between
            ...
            <div>
              <div className="item">
                <img
                  alt="article"
                  className="item-image"
                  src="/images/Smart India Hackathon.jpg"
                  style={{ width: 200 }}
                />
                <h3 className="item-head">Smart India Hackathon 2018</h3>
                <p className="item-desc">
                  UK India Education Research Initiative (UKIERI) was started in
                  April 2006 with the aim of enhancing educational links between
                  India and the United Kingdom.
